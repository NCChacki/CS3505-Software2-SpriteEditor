...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCanvasWidgetENDCLASS_t qt_meta_stringdata_CLASSCanvasWidgetENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(34, 12)   // "mousePressed"
    },
    "CanvasWidget",
    "canvasClicked",
    "",
...
void CanvasWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->canvasClicked((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CanvasWidget::*)(QPointF , bool );
...
// SIGNAL 0
void CanvasWidget::canvasClicked(QPointF _t1, bool _t2)
{
