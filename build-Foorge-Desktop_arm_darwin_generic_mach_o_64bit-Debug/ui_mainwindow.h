...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(0, 0, 591, 102));
        ...
        menuFoorge = new QMenu(menubar);
        menuFoorge->setObjectName("menuFoorge");
        MainWindow->setMenuBar(menubar);
        statusbar = new QStatusBar(MainWindow);
        statusbar->setObjectName("statusbar");
        MainWindow->setStatusBar(statusbar);

        menubar->addAction(menuFoorge->menuAction());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actualSizePreview->setText(QCoreApplication::translate("MainWindow", "Actual Size", nullptr));
        menuFoorge->setTitle(QCoreApplication::translate("MainWindow", "Foorge", nullptr));
    } // retranslateUi
