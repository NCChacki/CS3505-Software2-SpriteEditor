...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        transparentLabel->setMinimumSize(QSize(400, 400));
        transparentLabel->setMaximumSize(QSize(400, 400));
        onionLabel = new QLabel(canvasWidget);
        onionLabel->setObjectName("onionLabel");
        onionLabel->setGeometry(QRect(0, 0, 400, 400));
        onionLabel->setMinimumSize(QSize(400, 400));
        onionLabel->setMaximumSize(QSize(400, 400));
        QPalette palette1;
